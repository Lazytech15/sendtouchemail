...
<head>
  ...
  <style>
    body { font-family: 'DM Sans', Arial, sans-serif; margin: 0; padding: 0; background: transparent; color: #111111; }
    .wrapper { max-width: 560px; margin: 32px auto; border-radius: 6px; overflow: hidden; background: #ffffff; border: 1px solid #e4e4e4; }
    .header { padding: 24px 32px; border-bottom: 3px solid #c8ff00; background: #f7f7f7; }
    .header-label { font-family: monospace; font-size: 10px; letter-spacing: 0.25em; color: #5a7a00; text-transform: uppercase; }
    .header-title { font-size: 24px; font-weight: 700; color: #111111; margin: 6px 0 0; }
    .source-badge { display: inline-block; margin-top: 10px; padding: 3px 10px; border-radius: 4px; font-family: monospace; font-size: 10px; letter-spacing: 0.15em; text-transform: uppercase; background: #edffc0; color: #3d5c00; border: 1px solid #c8ff00; }
    .body { padding: 28px 32px; }
    .field { margin-bottom: 18px; padding-bottom: 18px; border-bottom: 1px solid #ebebeb; }
    .field:last-child { border-bottom: none; margin-bottom: 0; }
    .field-label { font-family: monospace; font-size: 10px; letter-spacing: 0.22em; color: #5a7a00; text-transform: uppercase; margin-bottom: 5px; }
    .field-value { font-size: 14px; color: #333333; line-height: 1.6; white-space: pre-wrap; }
    .field-value a { color: #5a7a00; text-decoration: none; }
    .footer { padding: 16px 32px; border-top: 1px solid #ebebeb; background: #f7f7f7; }
    .footer p { font-family: monospace; font-size: 11px; color: #aaaaaa; margin: 0; letter-spacing: 0.06em; }
