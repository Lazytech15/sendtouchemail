/* eslint-disable */
// Manually updated for contact email worker
// Run `npx wrangler types` after deploy to regenerate automatically
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
	}
	interface Env {
		EMAIL_WORKFLOW: Workflow<Parameters<import("./worker/workflow").EmailWorkflow['run']>[0]['payload']>;
